...
macOS 14 이전 버전일 경우, Control(^)을 누른 상태에서 앱을 클릭해 '열기' 시 바로 4번 단계로 진행됩니다.

## 사용 방법
> 더욱 편한 사용을 위해 메뉴바 아이콘 아래에 드롭존이 추가되었습니다! (v1.0.4 이상)
1. FileNic 실행 시 상단 메뉴바에 아이콘이 생성됩니다.
2. 변환이 필요한 파일을 메뉴바 아이콘 또는 드롭존으로 드래그 앤 드롭
...
- **최신 버전 설치**
   ...
   - 이후 [앱 실행 시 보안 경고 해결 방법](#앱-실행-시-보안-경고-해결-방법)을 따라 진행하세요.
